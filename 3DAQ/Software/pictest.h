...
#define  PANEL_continuous                8       /* callback function: continuous_hit */
...
int  CVICALLBACK continuous_hit(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
